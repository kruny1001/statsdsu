...
angular.module('statsdsuApp')
  .factory('chatFactory', function () {
    ...
    var setImageUrl = function(imageUri, imgElement) {
    ...
    var signIn = function(googleUser) {
    ...
    var resetMaterialTextfield = function(element) {
      element.value = '';
    ...
    return {
      ...
      resetMaterialTextfield: resetMaterialTextfield,
