...
/**
 * @ngdoc directive
 * @name statsdsuApp.directive:codeTerminal
 * @description
 * # codeTerminal
 */
angular.module('statsdsuApp')
  .directive('codeTerminal', function ($q) {
    return {
      templateUrl: 'views/templates/codeTerminal/codeTerminal.html',
      restrict: 'E',
      link: function postLink(scope, element, attrs) {
        ...
        scope.appendCommand = function(cmdInst){
          terminal.append(cmdInst + "\n");
          var result = runOpenCpu(cmdInst);
          result.then(function(result){
            terminal.append(result + "\n");
            displayPrompt();
          }, function(reason) {
            terminal.append('Failed: ' + reason + '\n');
            displayPrompt();
          })
        }

        var runOpenCpu = function(code){
...
// Display last-login and promt
          ...
          terminal.append("Type antrhing at the prompt, and R will evaluate it and print the answer\n");
          displayPrompt();
