...
angular.module('statsdsuApp')
  .controller('SurveyCtrl', function ($scope) {
    ...
    var ref = firebase.database().ref().child('survey').child('2017').child('gamebootstrap1');
    ...
    $scope.radioData = [
      ...
      { value: 2, desc:'I learned some basic game development in this camp.'},
      { value: 3, desc:'I was treated nicely by the organizers.'},
      { value: 4, desc:'The food could be better.'},
      ...
      { value: 5, desc:'I will recommend this camp to a friend. '},
      ...
      { value: 6, desc:'This camp has some impact on my future plan on career development. '},
